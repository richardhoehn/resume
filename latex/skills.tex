...
\cvlist{
    ...
    \item \cvskill{B2B, Public Speaking, Lecture \& Training} {+10 yrs}\\
}


\textcolor{maincol} {\cvtext{\textbf{\begin{flushleft}Technical\end{flushleft}}}}\\
\cvlist{
    \item \cvskill{Python, Node.JS, C\#, Dart, Javascript, SQL, Spark} {20+ yrs}\\
    ...
    \item \cvskill{AWS, SQS, SNS, S3, CloudFormation, Kafka, Lambdas} {10+ yrs}\\
    \item \cvskill{GCP, Firebase, Dart} {5+ yrs}\\
    \item \cvskill{Docker, Imaging, ECS, NGINX, YAML} {5+ yrs}\\
